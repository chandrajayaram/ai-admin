...
import com.ai.message.servlet.MessageServlet;
...
public class CassandraConfig {
	...
	@Autowired
	@Bean
	public ServletRegistrationBean dispatcherServlet(MessageService service) {
		return new ServletRegistrationBean(new MessageServlet(service), "/caiso/SyncMessagingService/*");
	}
	/*
	 ...
	 * return cluster; }
	 * 
	 * @Bean public CassandraMappingContext mappingContext() { return new
	 * BasicCassandraMappingContext(); }
	 * 
	 * 
	 * @Bean public CassandraConverter converter() { return new
	 ...
	 * session.setSchemaAction(SchemaAction.NONE); return session; }
	 * 
	 * @Bean public CassandraTemplate cassandraTemplate() throws Exception {
